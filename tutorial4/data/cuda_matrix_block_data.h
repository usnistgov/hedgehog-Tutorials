...
#ifndef TUTORIAL4_CUDA_MATRIX_BLOCK_DATA_H
#define TUTORIAL4_CUDA_MATRIX_BLOCK_DATA_H
#include <cublas_v2.h>
...
class CudaMatrixBlockData : public MatrixBlockData<Type, Id, Order::Column>,
 ...
 public:
  ...
  std::shared_ptr<MatrixBlockData<Type, Id, Order::Column>> copyToCPUMemory(cudaStream_t stream) {
    ...
    hh::checkCudaErrors(cudaMemcpyAsync(res->blockData(),
                                        this->blockData(),
...
#endif //TUTORIAL4_CUDA_MATRIX_BLOCK_DATA_H
