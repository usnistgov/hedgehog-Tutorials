...
#ifndef TUTORIAL3_INPUT_BLOCK_STATE_H
#define TUTORIAL3_INPUT_BLOCK_STATE_H
...
> {
 ...
 public:
  ...
  void execute([[maybe_unused]]std::shared_ptr<MatrixBlockData<Type, 'a', Ord>> ptr) override {
    matrixA(ptr);
  ...
  void execute([[maybe_unused]]std::shared_ptr<MatrixBlockData<Type, 'b', Ord>> ptr) override {
    matrixB(ptr);
...
#endif //TUTORIAL3_INPUT_BLOCK_STATE_H
