...
#ifndef TUTORIAL6_MATRIX_ROW_TRAVERSAL_TASK_H
#define TUTORIAL6_MATRIX_ROW_TRAVERSAL_TASK_H
...
class MatrixRowTraversalTask : public hh::AbstractTask<1, MatrixData<Type, Id, Ord>, MatrixBlockData<Type, Id, Ord>> {
 public:
  MatrixRowTraversalTask()
      : hh::AbstractTask<1, MatrixData<Type, Id, Ord>, MatrixBlockData<Type, Id, Ord>>("RowTraversal") {}
...
#endif //TUTORIAL6_MATRIX_ROW_TRAVERSAL_TASK_H
