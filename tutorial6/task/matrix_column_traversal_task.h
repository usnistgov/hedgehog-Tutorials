...
#ifndef TUTORIAL6_MATRIX_COLUMN_TRAVERSAL_TASK_H
#define TUTORIAL6_MATRIX_COLUMN_TRAVERSAL_TASK_H
...
class MatrixColumnTraversalTask
    : public hh::AbstractTask<1, MatrixData<Type, Id, Ord>, MatrixBlockData<Type, Id, Ord>> {
 public:
  MatrixColumnTraversalTask()
      : hh::AbstractTask<1, MatrixData<Type, Id, Ord>, MatrixBlockData<Type, Id, Ord>>("ColumnTraversal") {}
...
#endif //TUTORIAL6_MATRIX_COLUMN_TRAVERSAL_TASK_H
