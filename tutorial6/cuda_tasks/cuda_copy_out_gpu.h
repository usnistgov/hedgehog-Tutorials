...
#ifndef TUTORIAL6_CUDA_COPY_OUT_GPU_H
#define TUTORIAL6_CUDA_COPY_OUT_GPU_H
...
class CudaCopyOutGpu
 ...
 public:
  ...
  std::shared_ptr<hh::AbstractTask<
      ...
      CudaMatrixBlockData<MatrixType, 'p'>,
      MatrixBlockData<MatrixType, 'p', Order::Column>
  >> copy() override { return std::make_shared<CudaCopyOutGpu>(this->blockSize_); }
};

#endif //TUTORIAL6_CUDA_COPY_OUT_GPU_H
