...
#ifndef TUTORIAL5_CUDA_COMPUTATION_GRAPH_H
#define TUTORIAL5_CUDA_COMPUTATION_GRAPH_H
...
class CUDAComputationGraph : public hh::Graph<
 ...
 public:
  CUDAComputationGraph(size_t n, size_t m, size_t p, size_t blockSize, size_t numberThreadProduct) :
    ...
    this->addEdge(productTask, copyOutTask);

    // Send Out the data
    this->output(copyOutTask);
  }
};

#endif //TUTORIAL5_CUDA_COMPUTATION_GRAPH_H
